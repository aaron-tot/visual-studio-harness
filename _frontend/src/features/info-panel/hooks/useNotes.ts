...
import { listNotes, listNotesBatched, listSessions, listWorkspaces } from "../../../lib/api";
  ...
  const refresh = useCallback(async () => {
    ...
    try {
      ...
      if (scope === "project") {
        ...
        const batchResult = await listNotesBatched({
          scope: "project",
