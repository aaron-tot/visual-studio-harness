...
import { listAudits, listAuditsBatched, listSessions, listWorkspaces } from "../../../lib/api";
  ...
  const refresh = useCallback(async () => {
    ...
    try {
      ...
      if (scope === "project") {
        ...
        const batchResult = await listAuditsBatched({
          scope: "project",
